...
const RequestCheckCard = () => {
    ...
    const notCircle = <Image source={require("../assets/images/icons/close.gif")} style={{
        width:150,
        height:150
    }}/>
        ...
        <View style={styles.container} >
            {
                ...
                add == "send" ?<Animation  text={"Your request has been sent successfully"}  image={circle} size={150}/> :null 
            }
            {
                add == "not" ? <Animation text={"Your request has failed Please try again!!!"} icon={notCircle} size={150}/> : null
            }
        </View>
    );
};
export default RequestCheckCard;
